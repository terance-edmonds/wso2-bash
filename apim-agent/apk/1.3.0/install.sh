...
helm install $helm_apim_name wso2apim/wso2am-cp --version 4.5.0-rc -f https://raw.githubusercontent.com/wso2/apk/main/helm-charts/samples/apim/cp/4.5.0-values.yaml -n $namespace
...
echo $'\n# Install APK DP #'
BLA::start_loading_animation "${BLA_braille_whitespace[@]}"
helm install $helm_apk_name wso2apk/apk-helm --version 1.3.0 -f https://raw.githubusercontent.com/wso2/apk/main/helm-charts/samples/apk/1.3.0-cp-enabled-values.yaml -n $namespace
BLA::stop_loading_animation
